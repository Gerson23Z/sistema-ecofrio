            ...
            <div class="modal-body">
                <form method="post" id="frmCita">
                    ...
                    <div class="moda-footer">
                        ...
                        <button class="btn btn-info" type="button" id="btnId"
                            onclick="registrarCita(event)">Registrar</button>
                        <button class="btn btn-info" type="button" id="btnIdMarcar" onclick="marcarCom(event)">Marcar
